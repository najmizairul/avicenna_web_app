...
<!--                <Button @click.prevent="">Show QRCode</Button>-->
        ...
        <modal :show="showQrCode" @close="showQrCode=false" class="p-6 my-8" v-show="qrCode">
...
export default defineComponent({
    ...
    computed: {
        ...
        allDrugsInStock() {
            return this.prescription.drugs.findIndex(drug => (drug.daily_dose * drug.duration) < drug.drug.quantity) !== -1
        }
    },
